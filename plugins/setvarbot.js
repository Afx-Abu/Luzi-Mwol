...
let baseURI = '/apps/' + config.HEROKU.APP_NAME;
   ...
   var l_dsc = ''
    ...
    Julie.addCommand({ pattern: 'sudo ?(.*)', fromMe: true, desc: 'changes sudo numbers', usage: '.sudo *your number*' }, (async (message, match) => {
        ...
        await message.sendMessage("♡︎ ɴᴇᴡ sᴜᴅᴏ ᴜᴘᴅᴀᴛᴇᴅ ♡︎")
    }));

    Julie.addCommand({ pattern: 'caption ?(.*)', fromMe: true, desc: 'changes all captions', usage: '.caption *Made by Abuser*' }, (async (message, match) => {
