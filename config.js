...
module.exports = {
    ...
    SESSION: process.env.LUZI_CODE === undefined ? '' : process.env.LUZI_CODE,
    ...
    NAME_STYLE: process.env.NAME_STYLE === undefined ? '© ʟᴜᴢɪ ᴍᴡᴏʟ ™' : process.env.NAMR_STYLE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀғᴇ ʙʏ ʟᴜᴢɪ' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '  ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʟᴜᴢɪ ᴍᴡᴏʟ࿐  \n\n   *ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ™*   \n' : process.env.BOT_NAME,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '' : process.env.OWNER_NAME,
    LUZI: process.env.LOGO_LINK === undefined ? 'https://bit.ly/3cwa8fv' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʟᴜᴢɪ ᴍᴡᴏʟ࿐' : process.env.BOTV2_NAME,
    LUZI_AI: process.env.LUZI_AI === undefined ? 'false' : process.env.LUZI_AI,
